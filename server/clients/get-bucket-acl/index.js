...
if (process.env.NODE_ENV === "development") {
  var GET_BUCKET_ACL_SVC_HOST = 'localhost';
  var GET_BUCKET_ACL_SVC_PORT = 7001;
}

if (process.env.NODE_ENV === "production") {
  var GET_BUCKET_ACL_SVC_HOST = process.env.GET_BUCKET_ACL_SVC_HOST;
  var GET_BUCKET_ACL_SVC_PORT  = process.env.GET_BUCKET_ACL_SVC_PORT;
}
